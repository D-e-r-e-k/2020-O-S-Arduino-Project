...
{ 
  ...
  // hhmmss ddmmYY
  Serial.begin(9600);
  Serial.println("Send timedate in  hhmmss");
...
{ 
  ...
  if (Serial.available() > 0) {
          ...
          char inChar = Serial.read();
              ...
              if (inChar == '\n')
              {
                // make sure the string numbers is not too long:
                if (sBuffer.length() < 7)
                {
                  Hour = stringToNumber(sBuffer.substring(0,2));
                  Minute = stringToNumber(sBuffer.substring(2,4));
                  Second = stringToNumber(sBuffer.substring(4,6));
                  Serial.print("Setting time to Hour ");
                  Serial.print(Hour);
                  ...
                  Serial.print(Second);
                  Serial.print("\n");
                  setTime(Hour, Minute, Second, 0,0,0);
                  sBuffer = "";
                }
              } else {
               sBuffer += inChar; 
